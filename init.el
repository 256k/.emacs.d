...
(custom-set-faces
 ...
 '(fringe ((t :background "#eff1f5")))
 '(header-line ((t :box (:line-width 4 :color "#efefef" :style nil))))
 '(header-line-highlight ((t :box (:color "#4c4f69"))))
 '(keycast-key ((t)))
 '(line-number ((t :background "#eff1f5")))
 '(mode-line ((t :box (:line-width 6 :color "#e6e9ef" :style nil))))
 '(mode-line-active ((t :box (:line-width 6 :color "#e6e9ef" :style nil))))
 '(mode-line-highlight ((t :box (:color "#4c4f69"))))
 '(mode-line-inactive ((t :box (:line-width 6 :color "#dce0e8" :style nil))))
