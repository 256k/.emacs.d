...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "JetBrains Mono" :foundry "nil" :slant normal :weight regular :line-height 180 :height 180 :width normal))))
 '(fringe ((t :background "#fcffff")))
 '(header-line ((t :box (:line-width 4 :color "#eaefef" :style nil))))
 '(header-line-highlight ((t :box (:color "#232323"))))
 '(keycast-key ((t)))
 '(line-number ((t :background "#fcffff")))
 '(mode-line ((t :box (:line-width 4 :color "#9ad0ff" :style nil))))
 '(mode-line-active ((t :box (:line-width 4 :color "#9ad0ff" :style nil))))
 '(mode-line-highlight ((t :box (:color "#232323"))))
 '(mode-line-inactive ((t :box (:line-width 4 :color "#d7dbdb" :style nil))))
 ...
 '(tab-bar-tab ((t :box (:line-width 4 :color "#fcffff" :style nil))))
 '(tab-bar-tab-inactive ((t :box (:line-width 4 :color "#b5b8b8" :style nil))))
 '(tab-line-tab ((t)))
 '(tab-line-tab-active ((t)))
 '(tab-line-tab-inactive ((t)))
 '(vertical-border ((t :background "#fcffff" :foreground "#fcffff")))
 '(window-divider ((t (:background "#fcffff" :foreground "#fcffff"))))
 '(window-divider-first-pixel ((t (:background "#fcffff" :foreground "#fcffff"))))
 '(window-divider-last-pixel ((t (:background "#fcffff" :foreground "#fcffff")))))
